...
import com.mineabyss.lib.bootstrap.MineAbyssPluginBoot;
...
public class CardinalBootstrap implements PluginBootstrap {
    ...
    private final MineAbyssPluginBoot cardinalBoot;

    public CardinalBootstrap() {
        this.cardinalBoot = new MineAbyssPluginBoot((pluginProviderContext) -> {
            //create our imperat
            return new Cardinal();
        });
    }
